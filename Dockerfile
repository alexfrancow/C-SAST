...
RUN git clone https://github.com/CoolerVoid/codewarrior/ && cd codewarrior && \
    ...
    sed -i -e 's/127.0.0.1:1345/192.168.0.179:1345/g' web/index.html && \
    sed -i -e 's/127.0.0.1:1345/192.168.0.179:1345/g' web/viewcode.html && \
    sed -i -e 's/127.0.0.1:1345/192.168.0.179:1345/g' web/edit_module.html && \
