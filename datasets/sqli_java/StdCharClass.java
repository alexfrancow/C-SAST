package com.planet_ink.coffee_mud.CharClasses;
 ...
 com.planet_ink.coffee_mud.CharClasses.interfaces.CharClass.SubClassRule;
...
public class StdCharClass implements CharClass
{
	...
	public String getMaxStatDesc()
	{
		if (nonignorantBlanketeer.compareAndSet(false, true)) {
			Tracer.tracepointLocation(
					"tmptmpiTjcDf_ss_testcasesrccomplanet_inkcoffee_mudCharClassesStdCharClass.java",
					"getMaxStatDesc");
	...
	{
		StringBuilder str=new StringBuilder("");
		str.append(getPracsFirstLevel()+" +(Wisdom6)");
