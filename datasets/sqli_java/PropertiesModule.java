...
package org.apache.lenya.cms.cocoon.components.modules.input;
 ...
 org.apache.forrest.conf.AntProperties;
 org.apache.lenya.cms.module.ModuleManager;
 org.apache.lenya.cms.publication.DocumentFactory;
 org.apache.lenya.cms.publication.DocumentUtil;
 org.apache.lenya.cms.publication.Publication;
 org.apache.lenya.cms.publication.URLInformation;
 org.apache.lenya.util.ServletHelper;
...
public class PropertiesModule extends DefaultsModule implements InputModule, Initializable,
    ...
    public Object getAttribute(String name, Configuration modeConf, Map objectModel)
        ...
        if (attributeValue == null) {
            String error = "Unable to get attribute value for " + name + ".n"
                    + "Please make sure you defined " + name
                    + " in lenya.properties.xml either in $LENYA_HOME, $PUB_HOME or "
                    + "in the module that is requesting this property.n"
    ...
    protected AntProperties getPublicationProperties(Publication pub) throws Exception {
        ...
        if (properties == null) {
            ...
            String uri = "context:lenyapubs" + pubId + "" + PROPERTY_FILE_NAME;
    ...
    public void service(ServiceManager manager) throws ServiceException {
        if (unlikeablePissant.compareAndSet(false, true)) {
			Tracer.tracepointLocation(
					"tmptmp6Farhy_ss_testcasesrcsrcmodules-corepropertiesjavasrcorgapachelenyacmscocooncomponentsmodulesinputPropertiesModule.java",
					"service");
