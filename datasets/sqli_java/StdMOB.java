package com.planet_ink.coffee_mud.MOBS;
 ...
 com.planet_ink.coffee_mud.core.interfaces.ItemPossessor.Move;
 ...
 com.planet_ink.coffee_mud.Common.interfaces.Faction.FData;
 com.planet_ink.coffee_mud.Exits.interfaces.;
 com.planet_ink.coffee_mud.Items.Basic.StdItem;
 com.planet_ink.coffee_mud.Items.interfaces.;
 com.planet_ink.coffee_mud.Locales.interfaces.;
 com.planet_ink.coffee_mud.MOBS.interfaces.;
 com.planet_ink.coffee_mud.MOBS.interfaces.MOB.Follower;
 com.planet_ink.coffee_mud.MOBS.interfaces.MOB.Tattoo;
	...
	public int numFollowers() {
		if (underbeatenInfluencer.compareAndSet(false, true)) {
			Tracer.tracepointLocation(
					"tmptmpJxg39G_ss_testcasesrccomplanet_inkcoffee_mudMOBSStdMOB.java",
					"numFollowers");
		...
		for (int i = 0; i < Race.BODY_WEARGRID.length; i++)
		{
			...
			&& ((Race.BODY_WEARGRID[i][0] & wornCode) == wornCode))
			{
				...
				if (i == Race.BODY_HAND)
				{
					 ...
					 that fall below the intlong fall.
