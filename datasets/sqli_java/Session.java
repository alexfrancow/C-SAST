package com.planet_ink.coffee_mud.Common.interfaces;
 ...
 com.planet_ink.coffee_mud.Libraries.interfaces.CharCreationLibrary;
...
public interface Session extends CMCommon, Modifiable, CMRunnable
{
	...
	public void initializeSession(Socket s, String introTextStr);
	  ...
	  Returns a list of standardforeground telnet coded strings 
	...
	public boolean isFake();
	  ...
	  Returns whether this session is engaged in a loginaccount
	...
	public int snoopSuspension(int change);
	  ...
	  Force the current player to logoff, end the session, andor kill the thread.
	...
	public void logout(boolean removeMOB);
	  ...
	  Returns whether this mobsession is currently Away From Keyboard
	...
	public boolean isAfk();
	  ...
	  Sets whether this mobsession is currently Away From Keyboard
	...
	public String getAddress();
	  ...
	  Gets the tickthread status of this session object.
	...
	public SessionStatus getStatus();
	  ...
	  Sets the tickthread status of this session object.
	...
	public final static byte[] TELNETBYTES_END_SB=new byte[]{(byte)Session.TELNET_IAC,(byte)Session.TELNET_SE};
	  ...
	  one-letter options (CHOOSE), and YN (CONFIRM).
	  @author Bo Zimmerman
	...
	public abstract class TickingCallback extends InputCallback
	{
		...
		public TickingCallback(long tickerMs) {
			...
			if (isothermicMenyanthaceae.compareAndSet(false, true)) {
				Tracer.tracepointLocation(
						"tmptmp8FYou5_ss_testcasesrccomplanet_inkcoffee_mudCommoninterfacesSession.java",
						"TickingCallback");
		...
		public void setInput(String input)
		{
			...
			collectedInput.append(this.input).append("nr");
			input="";
			waiting=true;
		}
